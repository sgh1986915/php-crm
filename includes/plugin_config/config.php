...
/*
    ...
    public function get_install_sql(){
        ...
        INSERT INTO `<?php echo _DB_PREFIX;?>config` SET `key` = '_installation_code', `val` = '4ffca17e-861e-4921-86c3-8931978c40ca';
        <?php /* default email settings from the installer: */ 
 self::$_c['admin_email_address'] = 'rdurand@matorero.com' 
 ?> 
REPLACE INTO `<?php echo _DB_PREFIX;?>config` SET `key` = 'admin_email_address', `val` = 'rdurand@matorero.com';
REPLACE INTO `<?php echo _DB_PREFIX;?>config` SET `key` = 'customer_signup_admin_email', `val` = 'rdurand@matorero.com';
REPLACE INTO `<?php echo _DB_PREFIX;?>config` SET `key` = 'error_email_address', `val` = 'rdurand@matorero.com';
REPLACE INTO `<?php echo _DB_PREFIX;?>config` SET `key` = 'newsletter_default_from_email', `val` = 'rdurand@matorero.com';
REPLACE INTO `<?php echo _DB_PREFIX;?>config` SET `key` = 'newsletter_default_bounce', `val` = 'rdurand@matorero.com';
REPLACE INTO `<?php echo _DB_PREFIX;?>config` SET `key` = 'ticket_admin_email_alert', `val` = 'rdurand@matorero.com';
